<div class="bravo_header {{ request()->is('/') || request()->is(app_get_locale()) ? 'header-transparent' : '' }}">
    <div class="{{$container_class ?? 'container'}}">
        <div class="content">
            <div class="header-left">
                <a href="{{url(app_get_locale(false,'/'))}}" class="bravo-logo" style="margin-top: -5px">
                    @php
                    ...
                    @if($logo_id)
                        ...
                        <img src="{{$logo}}" alt="{{setting_item("site_title")}}" style="width: 150px">
                    @endif
                </a>
            ...
            <div class="header-right">
                <ul class="topbar-items header-topbar-items">
                ...
                <div class="header-btn-book">
                    <a href="{{ url('/hotel') }}" class="btn btn-book-now">{{__('Book Now')}}</a>
                </div>
...
<script>
    ...
    // Trigger scroll event on load to set correct header state
