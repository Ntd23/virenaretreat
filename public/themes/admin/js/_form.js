        ...
        tinymce.init({
            ...
            setup: function(editor) {
              ...
              editor.on('submit', function(event) {
               ...
               content_style:
    "@import url('https://fonts.googleapis.com/css2?family=Arial:wght@900&family=Roboto&display=swap');",
            valid_elements: '*[*]',
            paste_as_text: true,
            cleanup: false,
            verify_html: false,
