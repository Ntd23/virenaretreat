<div class="sec-title text-center">
    <h2>{{ __(setting_item_with_lang('user_plans_page_title', app()->getLocale())) ?? __("Pricing Packages")}}</h2>
    <div class="text">{{ __(setting_item_with_lang('user_plans_page_sub_title', app()->getLocale())) ?? __("Choose your pricing plan") }}</div>
</div>
<div class="pricing-tabs tabs-box">
    <div class="tab-buttons">
        <h4>{{ __(setting_item_with_lang('user_plans_sale_text', app()->getLocale())) ?? __('Save up to 10%') }}</h4>
        <ul class="tab-btns">
