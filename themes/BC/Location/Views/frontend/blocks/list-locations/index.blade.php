...
<div class="container-fluid px-0">
    <div class="row align-items-stretch list-locations-banner-wrapper no-gutters">
        ...
        <div class="col-xl-2 col-lg-3 d-none d-lg-block">
            <a href="{{ $banner_left_link ?: '#' }}" class="location-side-banner d-block h-100">
                <div class="banner-bg" style="background-image: url('{{ $banner_left_url ?: 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=600&q=80' }}');"></div>
        ...
        <!-- Right Banner -->
        <div class="col-xl-2 col-lg-3 d-none d-lg-block">
            <a href="{{ $banner_right_link ?: '#' }}" class="location-side-banner d-block h-100">
                <div class="banner-bg" style="background-image: url('{{ $banner_right_url ?: 'https://images.unsplash.com/photo-1476514525535-07fb3b4ae5f1?auto=format&fit=crop&w=600&q=80' }}');"></div>
                <div class="banner-overlay"></div>
