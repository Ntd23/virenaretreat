...
<div class="container-fluid px-0">
    <div class="row align-items-stretch list-locations-banner-wrapper no-gutters">
        ...
        <!-- Central Grid -->
        <div class="col-xl-8 col-12 px-4 px-md-5">
...
@push('css')
    <style>
        ...
        @media (max-width: 1199px) {
            .js-placeholder-left, .js-placeholder-right {
            ...
            .list-locations-banner-wrapper .col-xl-8 {
        ...
        @media (max-width: 767px) {
            ...
            .bravo-list-locations .list-item .destination-item,
            .bravo-list-locations .list-item .destination-item .image {
