                    ...
                    <ul class="filter-items row">
                        <?php $__currentLoopData = $item->terms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $term): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <li class="filter-term-item col-xs-6 col-md-4">
                                <label><input <?php if(in_array($term->id,$selected)): ?> checked <?php endif; ?> type="checkbox" name="terms[]" value="<?php echo e($term->id); ?>"> <?php echo e(__($translate->name)); ?>
...
<?php /**PATH /home/virenaretreat/main/themes/BC/Tour/Views/frontend/layouts/search-map/advance-filter.blade.php ENDPATH**/ ?>