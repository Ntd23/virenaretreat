            ...
            <div class="terms">
                <div class="g-attributes">
                    ...
                    <?php $__currentLoopData = $termsByAttribute; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $term): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <span class="item <?php echo e($term->slug); ?> term-<?php echo e($term->id); ?>"><?php echo e(__($translate_term->name)); ?></span>
...
<?php /**PATH /home/virenaretreat/main/themes/BC/Hotel/Views/frontend/layouts/search/loop-list.blade.php ENDPATH**/ ?>