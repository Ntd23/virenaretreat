    ...
    <div class="<?php echo e($container_class ?? 'container'); ?>">
        <div class="content">
            <div class="header-left">
                <a href="<?php echo e(url(app_get_locale(false,'/'))); ?>" class="bravo-logo" style="margin-top: -5px">
                    <?php
                    ...
                    <?php if($logo_id): ?>
                        ...
                        <img src="<?php echo e($logo); ?>" alt="<?php echo e(setting_item("site_title")); ?>" style="width: 150px">
                    <?php endif; ?>
                </a>
...
<?php /**PATH /Users/hoangquan/Desktop/virenaretreat/modules/Layout/parts/header.blade.php ENDPATH**/ ?>