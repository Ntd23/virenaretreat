...
<?php $__env->startSection('content'); ?>
    <div class="bravo_search_hotel">
        <div class="bravo_banner" <?php if($bg = setting_item("hotel_page_search_banner")): ?> style="background-image: url(<?php echo e(get_file_url($bg,'full')); ?>)" <?php endif; ?> >
            <div class="container">
                <h1>
                    <?php echo e(__(setting_item_with_lang("hotel_page_search_title"))); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/virenaretreat/main/themes/BC/Hotel/Views/frontend/search.blade.php ENDPATH**/ ?>